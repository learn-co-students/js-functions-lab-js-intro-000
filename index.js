...
function happyHolidays() {
  return "Happy holidays!";   // The function returns the product of p1 and p2
}

//This function should accept a parameter of the name of the person you want to wish happy holidays, and return the string `Happy holidays, ${name}!`
//function happyHolidaysTo(name) {
//  return "Happy holidays, " + name + "!";   // The function returns the product of p1 and p2
//}
