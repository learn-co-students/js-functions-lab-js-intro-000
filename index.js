// write your code below! This was completely balnk when starting
...
function happyHolidaysTo (name) {
  return `Happy holidays, ${name}!` // could have also use  return "Happy holidays, " + name + "!"
}
...
function happyHolidayTo (holiday, name) {
  return `Happy ${holiday}, ${name}!` // couls have also used return "Happy " + holiday + ", " + name + "!"
}
